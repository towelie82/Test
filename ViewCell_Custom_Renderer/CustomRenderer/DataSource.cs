...
namespace CustomRenderer
{
	public class DataSource
	{
		...
		public static List<DataSource> GetList ()
		{
			...
			l.Add (new DataSource ("Asparagus", "Vegetables", "next"));
			l.Add (new DataSource ("Avocados", "Vegetables", "next"));
			l.Add (new DataSource ("Beetroots", "Vegetables", "next"));
			l.Add (new DataSource ("Capsicum", "Vegetables", "next"));
			l.Add (new DataSource ("Broccoli", "Vegetables", "next"));
			l.Add (new DataSource ("Brussel sprouts", "Vegetables", "next"));
			l.Add (new DataSource ("Cabbage", "Vegetables", "next"));
			l.Add (new DataSource ("Carrots", "Vegetables", "next"));
			l.Add (new DataSource ("Cauliflower", "Vegetables", "next"));
			l.Add (new DataSource ("Celery", "Vegetables", "next"));
			l.Add (new DataSource ("Corn", "Vegetables", "next"));
